...
// configuration part
#define AWARDNAME "barrel" // Name of award
#define PRICE 15 // Award price
#define AWARDTEAM ZP_BOTH // Set team that can buy this award (use ZP_BOTH ZP_HUMANS ZP_ZOMBIES)
#define TRANSLATIONS "plague_barrel.phrases" // Set translations file for this subplugin
// end configuration
...
public ZP_OnAwardBought( client, const String:awardbought[])
{
	if(StrEqual(awardbought, AWARDNAME))
	{
		...
		PrintToChat(client, "\x04[Internacional ZP] \x05%t", "you bought barrel");
