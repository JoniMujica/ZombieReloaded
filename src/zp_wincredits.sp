...
public OnPluginStart()
{
	...
	disparos = CreateConVar("zombieplague_shots", "20", "Number of shots to zombies for receive credits");
...
{
	PrintToChatAll("\x04[Internacional ZP] \x05%t","Mata jugadores para conseguir creditos");
	PrintToChatAll("\x04[Internacional ZP] \x05%t","Escribe !premios para gastar tus creditos en premios");
}
